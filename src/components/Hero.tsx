    ...
    <section className="bg-blue-600 relative overflow-hidden w-full border-b border-blue-700/50">
      ...
      <div className="max-w-[1700px] mx-auto px-6 md:px-16 py-12 md:py-20 flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-20 relative z-10">
        ...
        <div className="text-white text-center md:text-left flex flex-col justify-center max-w-4xl order-1 md:order-2 flex-1">
          ...
          {/* ACCIONES - Botones convertidos a Links */}
          <div className="flex flex-wrap gap-5 justify-center md:justify-start pt-2">
            
            <Link 
              href="/doctrinas" 
              className="group bg-white text-blue-700 px-10 py-4 rounded-2xl font-black shadow-2xl hover:bg-blue-50 transition-all active:scale-95 flex items-center gap-3 uppercase tracking-tight text-base"
            >
            ...
            <Link 
              href="/nosotros" 
              className="group bg-blue-700/40 border border-blue-400/30 text-white px-10 py-4 rounded-2xl font-black backdrop-blur-md hover:bg-blue-800/60 transition-all active:scale-95 flex items-center gap-3 uppercase tracking-tight text-base"
            >
